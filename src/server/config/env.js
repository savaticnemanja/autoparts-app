...
const META_TEMPLATE_OWNER_ROADSIDE_NOTIFICATION = "owner_roadside_notification";
const META_TEMPLATE_ROADSIDE_NOTIFICATION = "roadside_notification";
const META_TEMPLATE_BUYER_ROADSIDE_NOTIFICATION = "buyer_roadside_notification";
